...
#
#   Time-stamp: <>
#   Touched: Fri Feb 01 09:02:52 2019 +0530 <enometh@meer.net>
...
# build from git
#
# ;madhu 190201 - 3.30.1-r1
# ;madhu 191018 - 3.35.1 - put patches in filesdir, make vanilla bogus
# ;madhu 200428 - 3.36.2
# ;madhu 201119 - 3.38.1 - EAPI 7 gnome2-utils
# ;madhu 210329 - 3.40.0
# ;madhu 221023 - 3.46.3
# ;madhu 221023 - 3.47.1 (from 3.46.2)
# ;madhu 230902 - 3.48.2
...
if  ${USE_GIT} ; then
	inherit git-r3
	SRC_URI=""
	EGIT_REPO_URI="https://gitlab.gnome.org.invalid/GNOME/gnome-terminal"
	EGIT_BRANCH=madhu-3.48.2
fi
...
if ! ${USE_GIT}; then
PATCHES=(
${FILESDIR}/3.48.2-0001-src-profile-editor.c-profile_prefs_load-allow-non-pa.patch
${FILESDIR}/3.48.2-0002-src-org.gnome.Terminal.gschema.xml-allow-option-NEVE.patch
${FILESDIR}/3.48.2-0003-toggle-tabs.patch
${FILESDIR}/3.48.2-0004-src-profile-editor.c-profile_prefs_load-choose-face.patch
${FILESDIR}/3.48.2-0005-src-terminal-client-utils.cc-fix-typo-spurious-inclu.patch
)
fi
...
#SRC_URI+=" https://www.example.com/~enometh/gnome-terminal-${PV}-patchset.tar.xz"
fi
