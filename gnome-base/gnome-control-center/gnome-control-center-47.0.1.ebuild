...
#
#   Time-stamp: <>
#   Touched: Wed Sep 11 09:14:29 2019 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2019 Madhu.  All Rights Reserved.
#
# ;madhu 190911 3.34.0.1 - add pulse,pwquality to IUSE
# ;madhu 191017 3.34.1 - use rodistdir for patches
# ;madhu 200215 3.35.90
# (rm -rf patches; mkdir patches; (cd patches; git format-patch master); tar cvfJ /gentoo/myrodistdir/gnome-control-center-3.35.90-patchset.tar.xz patches/00*)
# ;madhu 200423 3.36.1 - EAPI 7 - use git-r3
# ;madhu 200723 3.37.3
# ;madhu 200920 3.38.0
# ;madhu 210329 40.0
# ;madhu 220408 42.0 - includes gentoo patchset
# ;madhu 221023 43.1
# ;madhu 230623 44.2
# ;madhu 241008 47.0.1
...
if ${USE_GIT}; then
	SRC_URI=""
	inherit git-r3
	EGIT_REPO_URI=https://gitlab.gnome.org.invalid/GNOME/gnome-control-center.git
	EGIT_BRANCH=madhu-47
	EGIT_SUBMODULES=()
else

#SRC_URI+=" https://dev.gentoo.org/~pacho/distfiles/${PN}-46.2-patchset.tar.xz"
#SRC_URI+=" https://example.com/enometh/${P}-patchset.tar.xz"
...
#;madhu 241008 47.0.1 really needs:
...
PATCHES=(
	...
	# ;madhu 241008 ship jumbo patch
	 ${FILESDIR}/${PV}-madhu.patch
#	"${WORKDIR}"/patches/
)
fi
...
src_prepare() {
	...
	echo  > po/LINGUAS
	echo > panels/datetime/po-timezones/LINGUAS
