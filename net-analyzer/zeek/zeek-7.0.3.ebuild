...
#
#   Time-stamp: <>
#   Touched: Sun Nov 17 06:30:16 2024 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2024 Madhu.  All Rights Reserved.
#
# ;madhu 241117 - 7.0.3 based off ./oubliette/net-analyzer/zeek/zeek-6.1.0.ebuild
# ln -sv /16/tmp.d/mirrors.d/github.com/zeek/zeek/releases/download/v7.0.3/zeek-7.0.3.tar.gz /gentoo/distfiles
...
SLOT="0"
IUSE=kerberos
IUSE="curl debug geoip2 ipsumdump ipv6 jemalloc +python sendmail
