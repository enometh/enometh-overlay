...
#
#   Time-stamp: <>
#   Touched: Thu Apr 27 12:04:30 2023 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2023 Madhu.  All Rights Reserved.
#
# ;madhu 230427 - 3.0.721-r1  3.0.721-10-ga219027

EAPI=8
USE_GIT=true
MY_COMMIT=a219027ec8ea6bb75647bef126dd44f56ac9c86e
...
DEPEND="acct-user/darkstat
	...
	net-libs/libpcap
	sys-libs/zlib
 !vanilla? ( net-dialup/ppp-scripts )
"
RDEPEND="${DEPEND}"
...
${FILESDIR}/darkstat-3.0.711--dump-capture-files-on-abnormal-exit.patch
${FILESDIR}/darkstat-3.0.712--summarize-traffic-totals-per-page.patch
${FILESDIR}/darkstat-3.0.719--cdefs.h-define-restrict-compilation-fix.patch
...
src_install() {
	...
	if ! use vanilla ; then
		insinto /etc/ppp/if-up.d
		doins ${FILESDIR}/darkstat.sh
		insinto /etc/ppp/if-down.d
		doins ${FILESDIR}/killdarkie.sh
	fi
}
