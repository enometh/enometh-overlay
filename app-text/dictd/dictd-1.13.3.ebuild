...
#
#   Time-stamp: <>
#   Touched: Thu Nov 21 15:19:14 2024 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2024 Madhu.  All Rights Reserved.
#
# ;madhu 241121 1.13.1 -> 1.13.3, drop ereconf patches, patch openrc init script to use existing dictd.conf by default (override with PREPCONFIG=1)
# viasf=1 curl -4 --head 'http://excellmedia.dl.sourceforge.net/project/dict/dictd/dictd-1.13.3/dictd-1.13.3.tar.gz'
