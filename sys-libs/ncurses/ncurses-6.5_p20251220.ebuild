...
#
#   Time-stamp: <>
#   Touched: Tue Sep 22 20:56:19 2026 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2026 Madhu.  All Rights Reserved.
#
# ;madhu 260922 ncurses-6.5_p20251220: interim
...
inherit flag-o-matic toolchain-funcs multilib multilib-minimal preserve-libs usr-ldscript
...
do_configure() {
	...
	#;madhu 260922 allow interrupted configure to work.
	mkdir "${BUILD_DIR}/${target}" -pv || die
