...
PATCHES=(
	...
	"${FILESDIR}"/xpra-4.3.0001.xpra-server-source-webcam_mixin.py-WebCamMixin.proce.patch
	"${FILESDIR}"/xpra-4.3.0002.xpra-sound-sink.py-SoundSink.__init__-start-off-with.patch
	"${FILESDIR}"/xpra-4.3.0003.xpra-sound-src.py-fix-monitor_devices-is-a-dict-not-.patch
	"${FILESDIR}"/xpra-4.3.0004-xpra-platform-xposix-keyboard.py-fix-str-byte-conver.patch
)
