...
if  ${USE_GIT} || [[ ${PV} == *9999 ]] ; then
	...
	if ${USE_GIT}; then
	EGIT_BRANCH="maint"
#	EGIT_COMMIT=768bb238c4843bf52847773a621de4dffa6b9ab5
	EGIT_SUBMODULES=()
	EGIT_MANPAGES_COMMIT=0e78259b2a6169bc3469ac36a814a8ad7658925
...
#	SRC_URI+=" ${SRC_URI_KORG}/${PN}-manpages-${DOC_VER}${EXPORT_SUFFIX}.tar.${SRC_URI_SUFFIX}"
#	SRC_URI+=" doc? ( ${SRC_URI_KORG}/${PN}-htmldocs-${DOC_VER}${EXPORT_SUFFIX}.tar.${SRC_URI_SUFFIX} )"
...
#	"${FILESDIR}"/git-2.21.0-quiet-submodules-testcase.patch
	...
	${FILESDIR}/git-2.39.2-init-don-t-reset-core.filemode-on-git-new-workdirs.patch
)
...
src_prepare() {
	...
	if false && use mediawiki-experimental ; then
		PATCHES+=(
	...
	sed -i -e 's|v\(\[0\-9\]\*)\)|V\1|g' GIT-VERSION-GEN
