...
IUSE="aqua +egl examples gamepad +geolocation gles2-only gnome-keyring +gstreamer gtk-doc +introspection +jpeg2k +jumbo-build libnotify +opengl seccomp spell systemd wayland webgl +X woff webp hyphen elogind"
...
#		-DUSE_LIBHYPHEN=$(usex hyphen)
		...
		-DUSE_SYSTEMD=$(usex systemd || usex elogind) # Whether to enable journald logging
