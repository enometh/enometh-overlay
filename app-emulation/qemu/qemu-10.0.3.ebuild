...
#
#   Time-stamp: <2025-07-28 00:41:50 IST>
#   Touched: Sun Jul 27 20:59:58 2025 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2025 Madhu.  All Rights Reserved.
#
# ;madhu 250727 10.0.3 - no doc (but see below), drop requse ensurepip on python, ebuild lies.
...
# ;madhu 250728 	pulseaudio? ( media-libs/libpulse )
# libpulse is provided by media-sound/pulseaudio::enometh-overlay
...
# ;madhu 250728 ebuild lies: !doc still requires sphinx-build, provisioned via /usr/bin/sphinx-build -> /16/pip.
#	doc? (
...
qemu_src_configure() {
	...
	conf_opts+=(
		...
		#;madhu 250728 --disable-xkbcommon
