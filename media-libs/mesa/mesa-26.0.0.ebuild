...
#
#   Time-stamp: <>
#   Touched: Wed Sep 30 19:19:33 2020 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2020 Madhu.  All Rights Reserved.
#
# ;madhu 200930 mesa-20.2.0_rc4.ebuild -> 2.20.0
# ;madhu 210909 21.2.1
# ;madhu 220106 21.3.3
# ;madhu 220314 22.0.0
# ;madhu 221214 22.3.0
# ;madhu 230620 23.1.1
# ;madhu 241006 24.2.4 no gallium
...
# madhu: gles1 gles2 for compat with older packages built with those
# flags
# ;madhu 260220 rip vdpau
IUSE="${IUSE_VIDEO_CARDS}
	cpu_flags_x86_sse2 debug  d3d9  gles1 +gles2 osmesa xa
	+llvm tools
...
# echo dev-util/bindgen-0.71.1 > /etc/portage/profile/package.provided/bindgen
...
# MADHU SKIP llvm setup
#	use llvm && llvm-r1_pkg_setup
	python-any-r1_pkg_setup

	if use opencl || (use vulkan && use video_cards_nvk); then
# MADHU SKIP RUST_PKG_SETUP
#		rust_pkg_setup
		:
	fi
# MADHU ALT-LLVM-RUST
	export CARGO=/opt/rust-1.92.0/bin/cargo RUSTC=/opt/rust-1.92.0/bin/rustc
	export PATH=/opt/rust-1.92.0/bin:$PATH
...
#		$(meson_feature opengl glvnd)
		...
		-Dtools="['glsl', 'intel', 'intel-ui', 'drm-shim']"
	)
