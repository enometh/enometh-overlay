...
#
#   Time-stamp: <>
#   Touched: Thu Jul 10 20:35:32 2025 +0530 <enometh@net.meer>
...
${FILESDIR}/portage-3.0.61-estrip-preserve-timestamps-with-elfutils-strip.patch
${FILESDIR}/portage-3.0.61-bin-misc-functions.sh-rpmbuild-fixes.patch
${FILESDIR}/portage-3.0.66-dbapi-don-t-refresh-binpkg-cache-unless-FORCE-is-in-.patch
)
