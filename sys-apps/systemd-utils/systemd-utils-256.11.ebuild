...
#
#   Time-stamp: <>
#   Touched: Fri Feb 21 14:35:34 2025 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2025 Madhu.  All Rights Reserved.
#
# ;madhu 250221 256.11 (ship debian patches from mxrepo.com/mx/repo/pool/main/s/systemd/systemd_252.6-1mx23+1.debian.tar.xz, WIP to also install systemd by default), no musl.
#  -abi_x86_32
...
src_prepare() {
	local PATCHES=( ${FILESDIR}/systemd-256.11-debian-patches.patch)

	if false && use elibc_musl; then
		PATCHES+=(
