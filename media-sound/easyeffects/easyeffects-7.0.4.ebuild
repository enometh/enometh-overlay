...
#
#   Time-stamp: <2023-05-16 18:55:19 IST>
...
PATCHES=( ${FILESDIR}/easyeffects-7.0.4-fix-algorithm-find-compilation.patch )
...
src_configure () {
	meson_src_configure "$@"
	sed -i -e 's|-isystem/usr/include/ |-I/usr/include -std=c++20 |g' ${BUILD_DIR}/build.ninja || die
}
