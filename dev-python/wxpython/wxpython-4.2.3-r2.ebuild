...
#
#   Time-stamp: <>
#   Touched: Thu Aug 14 21:04:47 2025 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2025 Madhu.  All Rights Reserved.
#
# ;madhu 250814 - 4.2.4-r2 - use bundled wxwidgets
...
# inherit  wxwidgets
inherit distutils-r1 multilib multiprocessing virtualx pypi
...
#	fi
	...
	#  --use_syswx
	local build_options="build_py --no_magic --jobs=$(makeopts_jobs) --verbose --release"
...
sys.path.insert(0, ".")' setup.py || die
	...
	find -name \*.mo -o -name \*.po | xargs rm -fv
...
#	cp -apfv "${S}/sip/cpp/sip_corewxAppTraits.cpp" "${S}" || die

#	eapply "${FILESDIR}/${PN}-4.2.2-no-stacktrace.patch" || die

	${PYTHON} build.py build || die
	${PYTHON} build.py build_py || die
