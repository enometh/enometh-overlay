...
#
#   Time-stamp: <>
#   Touched: Wed Jun 30 18:10:39 2021 +0530 <enometh@net.meer>
#   Bugs-To: enometh@net.meer
#   Status: Experimental.  Do not redistribute
#   Copyright (C) 2021-2023 Madhu.  All Rights Reserved.
#
# ;madhu 210630 1.12.16-r1
# ;madhu 230601 1.12.16-r2 slot 46, drop example, pkgconfig
...
src_install() {
	...
	if [ "$SLOT" = "46" ]; then
		rm -fv ${ED}/usr/include/dbus-1.0/dbus/dbus-python.h
		rm -fv ${ED}/usr/$(get_libdir)/pkgconfig/dbus-python.pc
	else
